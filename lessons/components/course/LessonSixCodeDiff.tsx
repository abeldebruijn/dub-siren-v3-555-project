...
const rateAndAmount = `from picozero import Button, LED, Pot
...
const rateAmountPitch = `from picozero import Button, LED, Pot
from time import sleep, ticks_diff, ticks_ms
...
export default function LessonSixCodeDiff() {
  return <CodeDiffPanel before={rateAndAmount} after={rateAmountPitch} label="Changes to main.py for the smoothed Pitch reading" />;
}
